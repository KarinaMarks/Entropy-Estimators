...
\begin{tabular}{|l|l|l|}
\hline
N & $\hat{H}_{N, 1}$ & $|Bias(\hat{H}_{N, 1})|$ \\
\hline
5,000 & $\hat{H}_{5000, 1} \approx 1.41856$ &  $|Bias(\hat{H}_{5000, 1})| \approx 0.0003782577 $  \\
50,000 & $\hat{H}_{50000, 1} \approx 1.418784 $ &  $|Bias(\hat{H}_{50000, 1})| \approx 0.0001546303  $  \\
100,000 & $\hat{H}_{100000, 1} \approx 1.419097 $ &  $|Bias(\hat{H}_{100000, 1})| \approx 0.0001583482  $  \\
500,000 & $\hat{H}_{500000, 1} \approx  $ &  $|Bias(\hat{H}_{500000, 1})| \approx   $  \\
1,000,000 & $\hat{H}_{1000000, 1} \approx  $ &  $|Bias(\hat{H}_{1000000, 1})| \approx   $  \\
5,000,000 & $\hat{H}_{5000000, 1} \approx  $ &  $|Bias(\hat{H}_{5000000, 1})| \approx   $  \\
10,000,000 & $\hat{H}_{10000000, 1} \approx  $ &  $|Bias(\hat{H}_{10000000, 1})| \approx   $  \\
\hline
\end{tabular}
