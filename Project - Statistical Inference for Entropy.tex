...
By considering the situation outline above, with $N=50000$ I have worked out the estimator for entropy;
\begin{equation}
\hat{H}_{50000, 1} \approx 1.418784
\end{equation}
Thus,
\begin{equation}
|Bias(\hat{H}_{50000, 1})| = |\hat{H}_{50000, 1} - H| \approx 0.0001546303
\end{equation}
