...
We have found the coefficients for the formula \ref{bias}, for $k=2$ are given by $c = 0.0746$ and $a = 0.5998$, thus;
\begin{equation}
...
We have found the coefficients for the formula \ref{bias}, for $k=3$ are given by $c = 0.1156$ and $a = 0.6443$, thus;
\begin{equation}
|Bias(\hat{H}_{N, 3})| \approx \frac{0.1156}{N^{0.5998}} \nonumber
\end{equation}
COMPARISON...
...
We have found the coefficients for the formula \ref{bias}, for $k=5$ are given by $c = 0.3557$ and $a = 0.7568$, thus;
\begin{equation}
...
\begin{table}
\caption{Comparison of coefficients of regression $a$ and $c$ from equation \ref{}, for 1-dimensional normal distribution} \label{normal_a_c_compare_table}
\begin{center}
\begin{tabular}{| l | l l |} 
\toprule
$k$ &  $a$ & $c$ \\
