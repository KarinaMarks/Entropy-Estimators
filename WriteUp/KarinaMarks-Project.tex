...
\usepackage{amsmath, amsfonts, graphicx, listings, booktabs, amstext, subcaption, url}
...
\end{equation}
This indicates that if the $s$-th moment of $X$ if finite, $ \mathbb{E}(|X|^s) < \infty$, for some $s > 0$ then the Shannon entropy of $X$ will also be finite, $H(X) < \infty$ \cite{book3}.  %TODO - fix this ref
