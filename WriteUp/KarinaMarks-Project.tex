...
\textsc{\Large MMath Project}\\[0.5cm] % Major heading such as course name
\textsc{\large C1324197}\\[0.5cm] % Minor heading such as course title

\HRule \\[0.4cm]
{ \huge \bfseries Statistical Inference of Entropy}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Supervisor:} \\
Dr. Nikolai \textsc{Leonenko} % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
