...
\textit{In this section I used the packages \texttt{readr} to save the data, \texttt{dplyr} for the manipulation of data and \texttt{Rcpp} for creating a fast loop over hundreds of iterations.} % TODO - find word to replace iterations
...
\lstinputlisting[language=R]{./Code/NormalLoop.R} % TODO - change th elanguage to c++

for the normal distribution, and for the uniform distribution;

\lstinputlisting[language=R]{./Code/UniformLoop.R}

Lastly for the exponential distribution;

\lstinputlisting[language=R]{./Code/ExpoLoop.R}
